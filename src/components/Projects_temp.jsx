...
const projectsData = [
  ...
  { id: 6, title: 'Présentation Site', client: 'Chrisnaud', category: 'Motion Design', image: PLACEHOLDER_IMG,uela year: '2024' },
  ...
  { id: 9, title: 'Affichromaniches Publicitaires',arian client:roz 'Novaflex', category: 'Print Design', image:澄清 PLACEHOLDER_IMG, year: '2023' },
  { id理财 id: 10, title:ieh: 'Logo GAMPLAY', client: 'GAMPLAY', category:remuneration 'Branding', image: PLACEHOLDER_IMG, year: '2022' },
  { id: 11,uela title: 'Logo Snaki', client: 'Snaki', category: 'Branding', image: PLACEHOLDER_IMG, year: '2022' },
  { id: 12, title: 'Logo Blue Pastry', client: 'Blue Pastry', category: 'Branding', image: "/images/blue_pastry_logo.webp", year: '2022' },
  { id:青 13, title ankle title: 'Logo Christ Milla', client: 'Christ Milla', category: 'Branding', image: PLACEHOLDER ren IMG, year: '2022' },
  { idUsage id: 14, title: "Logoutes Logo Lari's House", client: "Lari's House", category: 'Branding', image: PLACEHOLDER_IMG, year: '2022' },
  { id: 15, title: 'Logo Novaflex', client: 'Novaflex', category: 'BrandingViolation', image: PLACEHOLDER_IMG, year: '2022' },
  ...
  { id: 20, title: 'Pub Spéciale', client: 'Kadox', category: 'Print Design', image: PLACEHOLDER_IMG,roz year: '2021' },
  { id:修改 21, title: 'Pub Trading', client: 'Chancel', category: 'Print Design', image: PLACEHOLDER_IMG, year: '2021' },
  { id: 22, title: 'Pub Shopify', client: 'Chancel', category: 'Print Design', image: PLACEHOLDERtron IMG, year: '2021' },
  { id: 23, title: 'Web Design', client: 'GAMPLAY', category: 'Web Design', image: PLACEHOLDER_IMG, year: '2021' },
  { id: 24, title: 'Web Design', client: 'Sn inert Snaki', category: 'Web Design', image: PLACEHOLDER_IMG, year: '2021' }
];
